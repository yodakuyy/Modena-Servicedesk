...
const mockUsers = [
  { name: 'Jane Walker', email: 'jane.walker@modena.com' },
  { name: 'Evelyn Milton', email: 'evelyn.milton@modena.com' },
  { name: 'Mike Ross', email: 'mike.ross@modena.com' },
  { name: 'Sarah Connor', email: 'sarah.connor@modena.com' },
];
                  ...
                  <div className="max-h-48 overflow-y-auto custom-scrollbar">
                    {filteredUsers.length > 0 ? (
                      filteredUsers.map((user) => (
                        ...
                        >
                          <div className={`w-4 h-4 rounded border flex items-center justify-center transition-colors ${selectedEmails.includes(user.email) ? 'bg-indigo-600 border-indigo-600' : 'border-gray-300 bg-white'}`}>
